...
docker run $TTY_FLAGS --rm \
  ...
  -e NANO_CLAW_INTELLIGENCE_TIMEOUT_MS \
  ...
  -e NANO_CLAW_EVAL_TRACE \
  -e NANO_CLAW_DISABLE_TOOLS \
  -e NANO_CLAW_OPERATOR_PASSWORD \
  -e NANO_CLAW_PHONE \
  -e TELNYX_API_KEY \
  ...
  -e NANO_CLAW_PHONE_MODEL \
  -e NANO_CLAW_PHONE_SPEED \
  -e NANO_CLAW_PHONE_STT_SIZE \
  -e NANO_CLAW_PHONE_STT_STREAM \
  ...
  -e NANO_CLAW_PHONE_RECORD_NOTICE \
  -e NANO_CLAW_CALL_RETENTION_DAYS \
  -e NANO_CLAW_PHONE_DISPLAY_NUMBER \
