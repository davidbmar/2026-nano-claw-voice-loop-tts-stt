...
export const EMOTIONS = {
  ...
  // mouthRound was 0.55 — a half-blend between the lens and the ellipse, which
  // is the worst place to sit: it produced a flat-bottomed trapezoid that read
  // as a dark blob rather than an open mouth. Compared side by side at 0.55,
  // 0.75, 0.9 and 1.0, only 0.9 is properly round while staying wide enough to
  // remain WONDER rather than the smaller recoil `surprised` already owns.
  awe: { highlightAngle: -1.25, lidLArch: 0.85, lidRArch: 0.85, browLY: 0.85, browRY: 0.85, eyeScaleY: 1.28, mouthOpen: 0.7, mouthWidth: 0.85, mouthRound: 0.9, mouthCorner: 0.25, pupilY: -0.3, blush: 0.5, binaryRain: 1.5 },
