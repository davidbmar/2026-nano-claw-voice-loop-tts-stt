...
import { DocumentsUI } from './documents.js?v=0.4.27';
...
async function switchRenderer(id) {
  ...
  if (next === 'mascot') {
    ...
    const { createMascotRenderer } = await import('./mascot-renderer.js?v=0.4.27');
    ...
    const { createRobotRenderer } = await import('./robot-renderer.js?v=0.4.27');
